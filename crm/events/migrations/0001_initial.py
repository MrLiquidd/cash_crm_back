    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_client', to='leads.lead', verbose_name='Клиент')),
                ('reflective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflective_event', to=settings.AUTH_USER_MODEL, verbose_name='Ответственный')),
            ],
        ),
    ]
